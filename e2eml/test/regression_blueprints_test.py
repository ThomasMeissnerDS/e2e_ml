...
def blueprint_regression_test_housingprices(blueprint='lgbm'):
    ...
    if blueprint == 'lgbm':
        ...
        titanic_auto_ml.ml_bp15_regression_full_processing_vowpal_wabbit_reg(preprocess_bp = 'bp_01')
        print("Start prediction on holdout dataset")
        titanic_auto_ml.ml_bp15_regression_full_processing_vowpal_wabbit_reg(val_df, preprocess_bp = 'bp_01')
